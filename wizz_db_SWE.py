...
url = 'https://be.wizzair.com/7.15.1/Api/search/search'
...
def main():
  ...
  #  print(price_wizz)
    ...
    if float_price_ticket_from <= 180 or float_price_ticket_to <= 180:
        post_ifttt_webhook('wizz_air_price', price_wizz)
    dest_to = str(data_tuple[0][1])
    dest_from = str(data_tuple[1][1])
 #   print(dest_to)
 #   print(dest_from)
 #   print(float_price_ticket_to, float_price_ticket_from)
